 ...
 */
public class VarianTigaRotiManis extends RotiManis implements Varian {
    protected String[][] filling = {{"Keju", "10"}, {"Sosis", "10"}};
    ...
    public void displayCheckVarian() {
        System.out.println("Varian 3 Roti Manis seharga Rp "+this.getHargaJualVarian());
    }
